-- Add total_duration_seconds to get_session_for_join response.
-- This is the sum of all question times so the client can block
-- late joiners once the quiz clock has fully elapsed.
...
BEGIN
  ...
  -- Sum of all question durations (same COALESCE logic as get_session_for_play)
  SELECT COALESCE(SUM(
