-- Return show_results_after_quiz from complete_quiz_attempt so the participant
-- completion screen always uses the freshest DB value (SECURITY DEFINER bypasses RLS).
