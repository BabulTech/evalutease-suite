...
-- Forces correct plan assignment based on selected_plan metadata.
-- Uses DO UPDATE instead of DO NOTHING on subscription conflict.
-- Also creates trial_ai_usage row for enterprise_starter signups.
-- ============================================================
