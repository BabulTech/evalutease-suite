...
export type SubCategoryDraft = { name: string; description: string };
...
type Props = {
  ...
  description?: string;
  submitLabel?: string;
  onSubmit: (draft: SubCategoryDraft) => Promise<void>;
};
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. World War II, Class 9, ICS Lecture 1"
              maxLength={120}
            />
          </div>
          <div>
