...
const FEATURE_LABELS: Record<PlanLimitKey, string> = {
  ...
  participants_total:       "Total active participants",
  question_bank:            "Question bank",
  sessions_total:           "Total sessions",
  schedules_per_day:        "Custom scheduling",
  custom_branding:          "Custom branding",
  custom_marking:           "Custom marking per question",
  custom_time_bonus:        "Custom time bonus",
};
