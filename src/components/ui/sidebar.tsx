/* eslint-disable sonarjs/no-duplicate-string, react-refresh/only-export-components -- generated shadcn/ui file; Tailwind data-attr classes and context+hook co-location are intentional */
...
function SidebarMenuSkeleton({
  ...
  // eslint-disable-next-line sonarjs/pseudo-random -- decorative skeleton width variation
